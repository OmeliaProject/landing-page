...
const HowToHelp: FunctionComponent<HowToHelpProps> = () => {
    ...
    const steps : Array<JSX.Element> = [
        <Step key={0} svgPath="/download.svg" title="Télécharger l'app" description="Omelia n'est pas encore disponible sur les stores, mais vous pouvez installer l'APK en cliquant sur l'image si dessus&nbsp;!" link="https://apk-bucket.s3.eu-west-3.amazonaws.com/omelia.apk"/>,
